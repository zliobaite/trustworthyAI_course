...
<span style="color:red">If the slides do not load directly from the menu, try to update the cache or using the links below.</span>
...
The course focuses on major design principles and concepts and is aimed at an interdisciplinary audience. There are no formal prerequisites.
