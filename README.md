...
### Lecture 1: introduction to trustworthy AI, explainability, interpretability

What is intelligence? Is current AI intelligent? Can we trust AI? 
Certification and reputation-based trust for AI systems. 
AI in decision support. A case study – a detailed example from the banking or alternative domain. 
Explainablity and explainable AI. Legal contexts and requirements for explainability. 
Black box vs. explainable models. Examples of algorithmic solutions. 
Do we always need explainability?
...
The course aims at an interdisciplinary audience with general interest in machine learning and AI.
The target audience are early career researchers interested in the societal aspects of AI. 
The course will offer a mix of conceptual and technical content, however, technical content will be explained so that no farmal prerequisites in math or computing are required.
